...
from utils.security_monitoring import SecurityEventType
...
class SecurityAuditor:
    ...
    async def run_full_audit(self) -> dict[str, Any]:
        ...
        for category_name, audit_func in categories:
            try:
                ...
                logger.exception(f"Failed to audit {category_name}: {e}")
    ...
    async def audit_configuration(self) -> dict[str, Any]:
        ...
        try:
            ...
            logger.exception(f"Configuration audit failed: {e}")
            result["error"] = str(e)
    ...
    async def audit_api_endpoints(self) -> dict[str, Any]:
        ...
        try:
            ...
            logger.exception(f"API endpoint audit failed: {e}")
            result["error"] = str(e)
    ...
    async def audit_dependencies(self) -> dict[str, Any]:
        ...
        try:
            ...
            logger.exception(f"Dependency audit failed: {e}")
            result["error"] = str(e)
    ...
    async def audit_authentication(self) -> dict[str, Any]:
        ...
        try:
            ...
            logger.exception(f"Authentication audit failed: {e}")
            result["error"] = str(e)
    ...
    async def audit_data_validation(self) -> dict[str, Any]:
        ...
        try:
            ...
            logger.exception(f"Data validation audit failed: {e}")
            result["error"] = str(e)
    ...
    async def audit_rate_limiting(self) -> dict[str, Any]:
        ...
        try:
            ...
            logger.exception(f"Rate limiting audit failed: {e}")
            result["error"] = str(e)
    ...
    async def audit_monitoring(self) -> dict[str, Any]:
        ...
        try:
            ...
            logger.exception(f"Monitoring audit failed: {e}")
            result["error"] = str(e)
