            ...
            <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-5 gap-12">
               ...
               <div className="col-span-2 space-y-8">
                  ...
                  <div className="flex gap-4">
                     <a href="https://github.com/graftai" title="Visit GraftAI on GitHub" aria-label="GraftAI GitHub" className="w-10 h-10 rounded-full bg-slate-900 border border-slate-800 flex items-center justify-center text-slate-400 hover:text-white hover:border-slate-600 transition-all">
                     ...
                     <a href="https://twitter.com/graftai" title="Visit GraftAI on Twitter" aria-label="GraftAI Twitter" className="w-10 h-10 rounded-full bg-slate-900 border border-slate-800 flex items-center justify-center text-slate-400 hover:text-white hover:border-slate-600 transition-all">
