...
def upgrade():
    ...
    op.create_table(
        ...
        sa.Column('user_id', sa.String(100), sa.ForeignKey('users.id', ondelete='CASCADE'), nullable=True),
    ...
    op.create_table(
        'email_logs',
        sa.Column('id', sa.String(100), primary_key=True),
        sa.Column('template_id', sa.String(100), sa.ForeignKey('email_templates.id', ondelete='SET NULL'), nullable=True),
