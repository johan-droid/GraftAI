...
- **Confidence**: [0-100]""",
            variables=["timezone", "current_time", "event_details", "available_slots", "user_message"],
            personality=PromptPersonality.PROFESSIONAL,
            category="calendar"
        )
...
- **Confidence**: [0-100]""",
            variables=["resource_type", "available_resources", "capacity", "time_requirements"],
            personality=PromptPersonality.PROFESSIONAL,
            category="resource"
        )
    ...
    def _build_system_prompt(self, personality: PromptPersonality) -> str:
        ...
        personality_prompts = {
            ...
            PromptPersonality.FRIENDLY: (
                "Be warm and helpful. "
                "Use encouraging language and show enthusiasm."
            )
        }
