...
class RateLimiter:
    ...
    def __init__(self, redis_client: redis.Redis | None=None, default_limit: int=100, default_window: int=60, strategy: RateLimitStrategy=RateLimitStrategy.SLIDING_WINDOW):
        ...
        self.endpoint_limits: dict[str, dict] = {
            "/api/v1/auth/social/exchange": {"limit": 15, "window": 300},
            "/api/v1/auth/refresh": {"limit": 10, "window": 60},
            "/api/v1/auth/mfa/enroll": {"limit": 5, "window": 300},
            "/api/v1/auth/mfa/enable": {"limit": 5, "window": 300},
            "/api/v1/auth/mfa/disable": {"limit": 5, "window": 300},
            "/api/v1/auth/mfa/verify": {"limit": 5, "window": 60},
            "/api/v1/auth/microsoft/login": {"limit": 10, "window": 300},
            "/api/v1/auth/google/login": {"limit": 10, "window": 300},
            "/api/v1/auth/sso/start": {"limit": 10, "window": 300},
            ...
            "/api/v1/billing/create-intent": {"limit": 10, "window": 300},
            "/api/v1/billing/razorpay/checkout": {"limit": 10, "window": 300},
            "/api/v1/billing/razorpay/verify": {"limit": 10, "window": 300},
            "/api/v1/billing/razorpay/cancel-subscription": {"limit": 5, "window": 300},
            "/api/v1/billing/stripe/create-checkout-session": {"limit": 10, "window": 300},
            "/api/v1/billing/stripe/create-portal-session": {"limit": 5, "window": 300},
            "/api/v1/billing/manual/request": {"limit": 5, "window": 3600},
            "/api/v1/billing/manual/presign": {"limit": 10, "window": 300},
