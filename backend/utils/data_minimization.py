...
class DataMinimizationEngine:
    ...
    def get_data_collection_audit_report(
        ...
        return {
            ...
            "prohibited_fields": list(collected_fields & DataMinimizationEngine.PROHIBITED_FIELDS),
            "consent_required_fields": list(collected_fields & DataMinimizationEngine.CONSENT_REQUIRED_FIELDS),
        }
