...
def upgrade():
    ...
    op.create_index(
        "ix_video_configs_provider", "video_conference_configs", ["provider"]
    )
    op.create_index(
        "ix_video_configs_user_provider",
        "video_conference_configs",
        ["user_id", "provider"],
        unique=True,
    )
    op.create_index(
        "ix_video_configs_default",
        "video_conference_configs",
        ["user_id", "is_default"],
    )
    ...
    op.create_table(
        ...
        sa.Column(
            "config_id",
            sa.String(100),
            sa.ForeignKey("video_conference_configs.id", ondelete="CASCADE"),
            nullable=False,
        ),
        sa.Column(
            "booking_id",
        ...
        sa.Column(
            "team_booking_id",
            sa.String(100),
            sa.ForeignKey("team_bookings.id", ondelete="SET NULL"),
            nullable=True,
        ),
        sa.Column("provider", sa.String(50), nullable=False),
    ...
    # Create indexes
    op.create_index(
        "ix_video_meetings_config_id", "video_conference_meetings", ["config_id"]
    )
    op.create_index(
        "ix_video_meetings_booking", "video_conference_meetings", ["booking_id"]
    )
    op.create_index(
        "ix_video_meetings_team_booking",
        "video_conference_meetings",
        ["team_booking_id"],
    )
    op.create_index(
        "ix_video_meetings_provider_id",
        "video_conference_meetings",
        ["provider_meeting_id"],
    )
    op.create_index(
        "ix_video_meetings_time", "video_conference_meetings", ["start_time", "status"]
    )
    ...
    op.create_table(
        ...
        sa.Column(
            "meeting_id",
            sa.String(100),
            sa.ForeignKey("video_conference_meetings.id", ondelete="CASCADE"),
            nullable=False,
        ),
    ...
    # Create indexes
    op.create_index(
        "ix_video_recordings_meeting", "video_conference_recordings", ["meeting_id"]
    )
    op.create_index(
        "ix_video_recordings_provider",
        "video_conference_recordings",
