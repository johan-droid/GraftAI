...
def upgrade():
    ...
    op.create_table(
        ...
        sa.Column('team_id', sa.String(100), sa.ForeignKey('teams.id', ondelete='CASCADE'), nullable=True),
    ...
    op.create_table(
        ...
        sa.Column('id', sa.String(100), primary_key=True),
        sa.Column('rule_id', sa.String(100), sa.ForeignKey('automation_rules.id', ondelete='CASCADE'), nullable=False),
