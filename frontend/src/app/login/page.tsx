...
import { Box, Button, Container, Typography, TextField, Card, CardContent, Divider, IconButton, InputAdornment } from '@mui/material';
...
export default function LoginPage() {
  ...
  return (
    <Box sx={{ minHeight: '100vh', background: 'linear-gradient(135deg, #0f0f1a 0%, #1a1a2e 50%, #0f0f1a 100%)', display: 'flex', alignItems: 'center' }}>
            ...
            <CardContent sx={{ p: { xs: 3, md: 5 } }}>
              ...
              <Box textAlign="center" mb={4}>
                ...
                <Typography variant="body2" sx={{ color: '#94a3b8' }}>
                  Sign in to continue to GraftAI
                </Typography>
              </Box>
              ...
              <form onSubmit={handleSubmit}>
                ...
                <Box sx={{ display: 'flex', justifyContent: 'flex-end', mb: 3 }}>
                  <Link href="/forgot-password" style={{ color: '#6366f1', textDecoration: 'none', fontSize: '0.875rem' }}>
                    Forgot password?
                  </Link>
                </Box>
