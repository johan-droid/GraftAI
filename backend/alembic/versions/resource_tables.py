...
def upgrade():
    ...
    op.create_index(
        "ix_resources_type_location", "resources", ["resource_type", "location"]
    )
    ...
    # Create indexes
    op.create_index(
        "ix_resource_bookings_resource", "resource_bookings", ["resource_id"]
    )
    ...
    op.create_index(
        "ix_resource_bookings_team_booking", "resource_bookings", ["team_booking_id"]
    )
    op.create_index(
        "ix_resource_bookings_resource_time",
        "resource_bookings",
        ["resource_id", "start_time", "end_time"],
    )
    op.create_index(
        "ix_resource_bookings_user_status", "resource_bookings", ["user_id", "status"]
    )
    ...
    # Create indexes
    op.create_index(
        "ix_resource_maintenance_resource", "resource_maintenance", ["resource_id"]
    )
    op.create_index(
        "ix_resource_maintenance_status", "resource_maintenance", ["status"]
    )
