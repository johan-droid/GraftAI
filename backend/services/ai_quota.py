...
async def is_ai_quota_available(db: AsyncSession, user: UserTable) -> tuple[bool, str]:
    ...
    if current >= limit:
        return (False, f"Daily AI request limit reached ({current}/{limit}). Upgrade your plan or wait until quota resets.")
