...
class EmailService:
    def send_booking_confirmation(self, to_email: str, to_name: str, meeting_title: str,
                                  start_time: str, end_time: str, meeting_url: str = None,
                                  location: str = None):
    ...
    def send_cancellation_notice(self, to_email: str, to_name: str, meeting_title: str,
                                 start_time: str, reason: str = None):
    ...
    def send_reminder(self, to_email: str, to_name: str, meeting_title: str,
                      start_time: str, meeting_url: str = None):
    ...
    def send_team_invitation(self, to_email: str, inviter_name: str, team_name: str,
                             invite_token: str):
    ...
    def send_password_reset(self, to_email: str, reset_token: str, user_name: str = None):
