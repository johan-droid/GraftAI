...
def upgrade():
    op.create_table("automation_rules", sa.Column("id", sa.String(100), primary_key=True), sa.Column("name", sa.String(200), nullable=False), sa.Column("description", sa.Text(), nullable=True), sa.Column("rule_type", sa.String(50), nullable=False), sa.Column("user_id", sa.String(100), sa.ForeignKey("users.id", ondelete="CASCADE"), nullable=False), sa.Column("team_id", sa.String(100), sa.ForeignKey("teams.id", ondelete="CASCADE"), nullable=True), sa.Column("conditions", postgresql.JSON(), default=dict), sa.Column("actions", postgresql.JSON(), default=dict), sa.Column("is_enabled", sa.Boolean(), default=True), sa.Column("confidence_threshold", sa.Float(), default=70.0), sa.Column("require_confirmation", sa.Boolean(), default=False), sa.Column("max_executions_per_day", sa.Integer(), nullable=True), sa.Column("execution_count_today", sa.Integer(), default=0), sa.Column("last_execution_at", sa.DateTime(timezone=True), nullable=True), sa.Column("priority", sa.Integer(), default=50), sa.Column("created_at", sa.DateTime(timezone=True), nullable=False), sa.Column("updated_at", sa.DateTime(timezone=True), nullable=False))
    ...
    op.create_index("ix_automation_rules_user_enabled", "automation_rules", ["user_id", "is_enabled"])
    op.create_index("ix_automation_rules_team_enabled", "automation_rules", ["team_id", "is_enabled"])
    op.create_index("ix_automation_rules_type_priority", "automation_rules", ["rule_type", "priority"])
    op.create_table("automation_executions", sa.Column("id", sa.String(100), primary_key=True), sa.Column("rule_id", sa.String(100), sa.ForeignKey("automation_rules.id", ondelete="CASCADE"), nullable=False), sa.Column("trigger_type", sa.String(50), nullable=False), sa.Column("trigger_data", postgresql.JSON(), default=dict), sa.Column("status", sa.String(20), default="pending"), sa.Column("action_taken", sa.Text(), nullable=True), sa.Column("result_data", postgresql.JSON(), default=dict), sa.Column("confidence_score", sa.Float(), default=0.0), sa.Column("automation_tier", sa.String(20), default="draft"), sa.Column("error_message", sa.Text(), nullable=True), sa.Column("retry_count", sa.Integer(), default=0), sa.Column("user_confirmed", sa.Boolean(), default=False), sa.Column("user_overridden", sa.Boolean(), default=False), sa.Column("started_at", sa.DateTime(timezone=True), nullable=False), sa.Column("completed_at", sa.DateTime(timezone=True), nullable=True))
    ...
    op.create_index("ix_automation_executions_started", "automation_executions", ["started_at"])
    op.create_table("automation_templates", sa.Column("id", sa.String(100), primary_key=True), sa.Column("name", sa.String(200), nullable=False), sa.Column("description", sa.Text(), nullable=False), sa.Column("category", sa.String(50), nullable=False), sa.Column("rule_type", sa.String(50), nullable=False), sa.Column("template_conditions", postgresql.JSON(), default=dict), sa.Column("template_actions", postgresql.JSON(), default=dict), sa.Column("default_confidence_threshold", sa.Float(), default=70.0), sa.Column("default_require_confirmation", sa.Boolean(), default=True), sa.Column("usage_count", sa.Integer(), default=0), sa.Column("is_featured", sa.Boolean(), default=False), sa.Column("is_active", sa.Boolean(), default=True), sa.Column("created_at", sa.DateTime(timezone=True), nullable=False))
    op.create_index("ix_automation_templates_category", "automation_templates", ["category"])
    op.create_index("ix_automation_templates_featured", "automation_templates", ["is_featured", "is_active"])
    bind = op.get_bind()
