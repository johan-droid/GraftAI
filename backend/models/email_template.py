...
class EmailTemplate(Base):
    ...
    available_variables: Mapped[list] = mapped_column(
        JSON, default=list
    )  # ["{{user_name}}", "{{booking_title}}", ...]
    ...
    user: Mapped[Optional["UserTable"]] = relationship(
        "UserTable", back_populates="email_templates"
    )
