...
async def test_send_calendar_invite(mock_send_email):
    ...
    result = await send_calendar_invite(attendee="test@example.com", title="Test Sync", start_time="2024-04-15T14:00:00Z", duration_minutes=45, location="Zoom", description="Let's sync", organizer="org@example.com")
