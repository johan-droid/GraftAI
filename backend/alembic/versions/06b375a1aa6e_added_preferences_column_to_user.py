...
def upgrade() -> None:
    ...
    op.alter_column('event_types', 'is_public',
               existing_type=sa.BOOLEAN(),
               nullable=False)
    op.alter_column('event_types', 'payment_currency',
               existing_type=sa.TEXT(),
               type_=sa.String(),
               existing_nullable=False,
               existing_server_default=sa.text("'USD'::text"))
    op.alter_column('event_types', 'team_assignment_method',
               existing_type=sa.TEXT(),
               type_=sa.String(),
               existing_nullable=False,
    ...
    op.alter_column('events', 'is_meeting',
               existing_type=sa.BOOLEAN(),
               nullable=False)
    op.alter_column('events', 'meeting_provider',
               existing_type=sa.TEXT(),
               type_=sa.String(),
               existing_nullable=True)
...
def downgrade() -> None:
    ...
    sa.ForeignKeyConstraint(['userId'], ['users.id'], name='account_userId_fkey', ondelete='CASCADE'),
    ...
    sa.Column('applied_at', postgresql.TIMESTAMP(timezone=True), server_default=sa.text('CURRENT_TIMESTAMP'), autoincrement=False, nullable=False),
    ...
    sa.ForeignKeyConstraint(['user_id'], ['users.id'], name='session_user_id_fkey', ondelete='CASCADE'),
    ...
    sa.Column('id', sa.INTEGER(), autoincrement=True, nullable=False),
    sa.Column('user_id', sa.VARCHAR(length=100), autoincrement=False, nullable=False),
    sa.Column('subscription_tier', sa.VARCHAR(length=50), autoincrement=False, nullable=True),
    sa.Column('monthly_ai_credits', sa.INTEGER(), autoincrement=False, nullable=True),
