...
def upgrade():
    ...
    op.create_index(
        "ix_integrations_user_provider", "integrations", ["user_id", "provider"]
    )
    ...
    # Create indexes
    op.create_index(
        "ix_integration_logs_integration_id", "integration_logs", ["integration_id"]
    )
    op.create_index(
        "ix_integration_logs_integration_sent",
        "integration_logs",
        ["integration_id", "sent_at"],
    )
