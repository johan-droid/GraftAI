...
def upgrade():
    ...
    # DSR Records table
    if "dsr_records" not in existing_tables:
        op.create_table(
            "dsr_records",
            sa.Column("id", sa.String(100), primary_key=True),
            sa.Column(
                "user_id", sa.String(100), sa.ForeignKey("users.id"), nullable=False
            ),
            ...
            sa.Column(
                "identity_verified_at", sa.DateTime(timezone=True), nullable=True
            ),
    ...
    if "dsr_audit_logs" not in existing_tables:
        op.create_table(
            "dsr_audit_logs",
            sa.Column("id", sa.String(100), primary_key=True),
            sa.Column(
    ...
    if "data_retention_schedules" not in existing_tables:
        op.create_table(
            "data_retention_schedules",
            sa.Column("id", sa.String(100), primary_key=True),
    ...
    if "consent_records" not in existing_tables:
        op.create_table(
            ...
            sa.Column(
                "analytics_withdrawn_at", sa.DateTime(timezone=True), nullable=True
            ),
            sa.Column(
                "marketing_withdrawn_at", sa.DateTime(timezone=True), nullable=True
            ),
            sa.Column(
                "ai_training_withdrawn_at", sa.DateTime(timezone=True), nullable=True
            ),
            sa.Column(
                "third_party_sharing_withdrawn_at",
    ...
    if "data_processing_records" not in existing_tables:
        op.create_table(
            "data_processing_records",
            sa.Column("id", sa.String(100), primary_key=True),
    ...
    if "data_breach_records" not in existing_tables:
        op.create_table(
            "data_breach_records",
            sa.Column("id", sa.String(100), primary_key=True),
            ...
            sa.Column(
                "supervisory_notified_at", sa.DateTime(timezone=True), nullable=True
            ),
            sa.Column("supervisory_authority", sa.String(100), nullable=True),
            sa.Column("data_subjects_notified", sa.Boolean(), default=False),
            sa.Column(
                "data_subjects_notified_at", sa.DateTime(timezone=True), nullable=True
            ),
